...
public class DropPlaceScript : NetworkBehaviour, IDropHandler //MonoBehaviour
{
    ...
    public void SetCardRpc(int findCoreId, int findID, FieldType fieldType)
    {
        ...
        */
        ...
        //<color=#FF0000>Текст</color> Красный
        //<color=#FFFFFF>Текст</color> Белый
                ...
                if (fieldType == FieldType.SELF_FIELD)
                {
                    switch (fieldNum)
                    {
                        case FieldNum.Num1:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Синее Поле 1 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Синее Поле 1 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                        ...
                        case FieldNum.Num2:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Синее Поле 2 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Синее Поле 2 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                        ...
                        case FieldNum.Num3:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Синее Поле 3 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Синее Поле 3 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                        ...
                        case FieldNum.Num4:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Синее Поле 4 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Синее Поле 4 Положили Карту</color> <color=#142BAD>{crdInfo.SelfCard.Name}</color>";
                ...
                else if (fieldType == FieldType.ENEMY_FIELD)
                {
                    switch (fieldNum)
                    {
                        case FieldNum.Num1:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Красное Поле 1 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Красное Поле 1 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                        ...
                        case FieldNum.Num2:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Красное Поле 2 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Красное Поле 2 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                        ...
                        case FieldNum.Num3:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Красное Поле 3 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Красное Поле 3 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                        ...
                        case FieldNum.Num4:
                            ...
                            {
                                GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>На Красное Поле 4 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
                                GameManager.LogTxtEnemy.text =  $"<color=#FFFFFF>На Красное Поле 4 Положили Карту</color> <color=#FF0000>{crdInfo.SelfCard.Name}</color>";
        ...
        if (fieldType == FieldType.SELF_SPELL_FIELD)
        {
            GameManager.LogTxtPlayer.text = $"<color=#FFFFFF>Синий Игрок Разыграл Заклинание</color> <color=#142BAD>{cardInf.SelfCard.Name}</color> <color=#FFFFFF>со способностью</color> <color=#FFCC66>{cardInf.SelfCard.PassiveAbilitiesText}</color>";
            GameManager.LogTxtEnemy.text = $"<color=#FFFFFF>Синий Игрок Разыграл Заклинание</color> <color=#142BAD>{cardInf.SelfCard.Name}</color> <color=#FFFFFF>со способностью</color> <color=#FFCC66>{cardInf.SelfCard.PassiveAbilitiesText}</color>";
